...
#Verificando quantas pessoas são menores de idade
    if idade < 21: 
        menoridade +=1 #se a pessoa for menor de idade, vai adicionar +1 na variavel menoridade
    else:
        maioridade +=1 #se a pessoa for maior de idade, vai adicionar +1 na variavel maioridade 
